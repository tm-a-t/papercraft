...
For actions tied to one message, [inline buttons](buttons#inline) are usually a better fit.
...
Enable inline mode in BotFather and select a placeholder if the default “Search...” is too generic.
...
[add a song](editing#edit-media) to a sent message and not load all songs during the search.
