...
For choosing between many options, consider [buttons](buttons) or [inline mode](inline).
...
- [Buttons](buttons) or [inline mode](inline) for choosing options
...
Your bot won't see commands ending with other bots' usernames. For more details, check the [privacy mode explanation.](groups#privacy)
