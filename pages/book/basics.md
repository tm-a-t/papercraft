...
- Send [rich messages](rich-messages) with tables, formulas, collapsible sections, and streamed AI output.
- Work as [guest bots](bot-automation#guest-bots) when users mention them in chats where the bot is not a member.
- Help automate user or business accounts with explicit access permissions.
- Help users create and manage other bots.
- Handle newer chat features such as [channel direct messages](channels#direct-messages-for-channels),
