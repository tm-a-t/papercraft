...
Подробнее о разработке ботов для групп см. [страницу о группах.](groups)
...
У ID групп и супергрупп есть различия, которые мы рассмотрим [на следующей странице.](chat-ids#bot-api)
Кроме того, обычные группы и супергруппы отличаются тем, как работают ID сообщений: см. [ID сообщений.](message-ids)

## Гигагруппы (broadcast groups)

Гигагруппы — это ещё один тип групп, но такой редкий, что я расскажу о нём только для справки.
