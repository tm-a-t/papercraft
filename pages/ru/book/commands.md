...
- [Кнопки](buttons) или [инлайн-режим](inline), когда нужно выбрать один из вариантов
...
Ваш бот [не увидит](groups#privacy) команды, которые заканчиваются на юзернейм другого бота.
